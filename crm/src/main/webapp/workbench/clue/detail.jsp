...
<script type="text/javascript">
	...
	$(function(){
		...
		//为关联市场活动模态窗口中的搜索框绑定键盘事件，通过出发回车键，查询市场活动列表
		...
		$("#modalBody").on("click", $("input[name=dx]"), function () {
...
<body>
	...
	<div style="position: relative; left: 40px; top: -30px;">
		...
		<div style="position: relative; height: 50px; width: 500px;  top: -72px; left: 700px;">
			<button type="button" class="btn btn-default" onclick="window.location.href='workbench/clue/convert.jsp?id=${clue.id}&company=${clue.company}&fullname=${clue.fullname}&appellation=${clue.appellation}&owner=${clue.owner}';"><span class="glyphicon glyphicon-retweet"></span> 转换</button>
